...
namespace RecRoomPSVR2.PSVR2
{
    ...
    public static class PSVR2ToolkitCAPI
    {
        ...
        private static extern UIntPtr psvr2_toolkit_loader_get_module_path(
            IntPtr buffer, UIntPtr bufferSize);
...
#pragma warning restore CS8618
        ...
        public static string GetModulePath()
        {
            ...
            try
            {
                ...
                UIntPtr requiredSizePtr =
                    psvr2_toolkit_loader_get_module_path(IntPtr.Zero, UIntPtr.Zero);

                ulong requiredSize = requiredSizePtr.ToUInt64();
                ...
                {
                    UIntPtr actualSize =
                        psvr2_toolkit_loader_get_module_path(
                            buffer,
                            new UIntPtr(requiredSize + 1));
...
#else
            // .NET Framework only runs on Windows, so directly use Win32GetProcAddress
            return Win32GetProcAddress(hModule, procName);
#endif
        }
